...
export class CreateClientMappingDto {
  ...
  @ApiProperty({ description: "'Unbundl' or a client company name.", maxLength: 200 })
  @IsString()
  @IsNotEmpty()
  @MaxLength(200)
  company!: string;
  ...
  @ApiPropertyOptional({ description: "Secondary escalation owner: another mapping row's id." })
  @IsOptional()
  @IsUUID()
  backupOwnerId?: string | null;

  @ApiPropertyOptional({ description: 'Group-kind opt-out for Phase 4 sentiment tracking.', default: true })
  @IsOptional()
  @ToStrictBoolean()
  @IsBoolean()
  sentimentTracking?: boolean;

  @ApiPropertyOptional({ description: 'Free-text context fed into the G Brain export.' })
  @IsOptional()
  @IsString()
  @MaxLength(4000)
  notes?: string | null;
