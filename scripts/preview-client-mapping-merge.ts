// docs/33 Phase D: preview or apply the client_mappings phone-duplicate merge that migration
// 1786600000000 (docs/33 Phase C) performs automatically, unattended, the next time the app boots
// against this database — merging is destructive (it deletes the loser row of each duplicate pair)
// and that migration otherwise gives an operator no chance to see it coming first.
//
